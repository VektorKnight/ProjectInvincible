...
using _3rdParty.Steamworks.Plugins.Steamworks.NET.types.MatchmakingTypes;
using _3rdParty.Steamworks.Plugins.Steamworks.NET.types.SteamMatchmaking;

namespace _3rdParty.Steamworks.Plugins.Steamworks.NET {
	//-----------------------------------------------------------------------------
