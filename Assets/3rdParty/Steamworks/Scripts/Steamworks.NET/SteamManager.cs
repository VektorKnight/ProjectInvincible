...
using _3rdParty.Steamworks.Plugins.Steamworks.NET.types.SteamClient;
...
//
namespace _3rdParty.Steamworks.Scripts.Steamworks.NET {
	...
	public class SteamManager : MonoBehaviour {
		...
		private void Awake() {
			...
			try {
				...
				if (SteamAPI.RestartAppIfNecessary((AppId_t)805810)) {
					Application.Quit();
					return;
				}
			}
